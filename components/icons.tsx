...
export const DocumentScanIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 8.25h4.5m-4.5 3.75h4.5m-4.5 3.75h4.5M3.75 12h16.5M12 3.75v16.5" />
    </svg>
);
